...
> Caso você receba a mensagem `npm test failed!` siga os passos abaixo:
* Deletar a pasta node_modules
* Instalar o jest globalmente com npm i -g jest
* Instalar novamente as dependencias com npm i
* Verificar se o seu arquivo jest.config.js se encontra da seguinte forma:
